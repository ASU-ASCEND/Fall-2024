 ...
 * CSV header, and number of data fields (3: current, voltage, and power).
 * 
 ...
 * 
 * This function initializes the INA260 sensor object and checks whether the sensor
 * is successfully detected on the I2C bus.
 * 
 ...
 * 
 * This function reads the current (in mA), bus voltage (in mV), and power (in mW) values
 * from the INA260 sensor and formats them into a CSV string.
 * 
