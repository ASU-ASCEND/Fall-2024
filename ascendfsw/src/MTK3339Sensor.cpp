...
/**
 * @brief Reads and returns data from the MTK3339 GPS corresponding to the CSV header 
 * 
 * @return String CSV segment in form of Date, Latitude, Longitude, Speed, Angle, Altitude, Satellites,
 */
