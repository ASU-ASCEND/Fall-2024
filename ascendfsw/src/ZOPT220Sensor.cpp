 ...
 * 
 * Initializes the ZOPT220 sensor object with a default minimum period of 0 milliseconds
 ...
 * 
 * Initializes the sensor object with a specified minimum period and sets up the sensor name,
 * CSV header, and the number of data fields (2: UV index and ambient light).
 * 
 * @param minimum_period The minimum time period between sensor readings, in milliseconds.
 */
 ...
 * 
 * This function collects the UV index and ambient light level (in lux) from the sensor.
 * It configures the sensor resolution, gain, and enables the respective sensing modes.
 * A delay is introduced to ensure data availability, and the data is then formatted into
 * a CSV string.
 * 
 * @return arduino::String A string containing the sensor readings in the format:
 * "UV Index, Ambient Light (lux), ".
 */
