...
/**
 * @brief Default constructor for the SGP30Sensor, sets the miniumum period to 0 ms
 * 
 */
 ...
 * 
 * @return String A CSV section in the form SGPTVOC(ppb), SGPeCO2(ppm), SGPTVOCBase(ppb), SGPeCO2Base(ppb), SGPH2, SGPEtha,
 */
